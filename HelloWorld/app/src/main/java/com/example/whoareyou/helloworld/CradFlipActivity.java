...
public class CradFlipActivity extends Activity implements FragmentManager.OnBackStackChangedListener{
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        MenuItem item = menu.add(Menu.NONE,R.id.action_flip,
                Menu.NONE,mShowingBack?R.string.action_photo:
        ...
        getFragmentManager().beginTransaction()
                .setCustomAnimations(
                        ...
                        R.animator.card_flip_left_out).replace(
                                R.id.container,new CardBackFragment())
